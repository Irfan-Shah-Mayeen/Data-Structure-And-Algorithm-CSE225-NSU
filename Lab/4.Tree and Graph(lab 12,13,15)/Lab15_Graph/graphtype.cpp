...
//  OutDegree function  returns the outdegree of a given vertex
template<class VertexType>
...
//  FoundEdge function ,if there is an edge or not
template<class VertexType>
...
//modify  BFS function and new function named BreadthFirstSearchLength

template<class VertexType>
void GraphType<VertexType>::BreadthFirstSearchLength(VertexType startVertex, VertexType endVertex) {
    QueType<VertexType> queue;
    QueType<VertexType> vertexQ;
